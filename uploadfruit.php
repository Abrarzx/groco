  ...
  if (isset($_POST['add_product'])) {
   ...
   $product_price = $_POST['product_price'];
    ...
    // image file directory
  	$target1= "fruit/".basename($fruit);

  	$sql = "INSERT INTO fruit (product_name,product_price,product_qty,product_image,product_code) VALUES ('$product_name', '$product_price','$product_qty','$fruit',$product_code)";
//   mysqli_query($conn,$sql);
   mysqli_query($conn,$sql);

   if (move_uploaded_file($_FILES['fruit']['tmp_name'], $target1))
   {
...
<div class="container">
   ...
   <div class="admin-product-form-container">
      ...
      <form action="uploadfruit.php" method="post" enctype="multipart/form-data">
         ...
         <input type="submit" class="btn" name="add_product" value="add fruit ">
      </form>
